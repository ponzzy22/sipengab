  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        <p class="login-box-msg">Masuk am dulu</p>
		<?php if($errorMessage != "&nbsp;" ) {?>
        ...
        <form action="" method="post">
          <div class="form-group has-feedback">
			...
			<span class="textfieldMinCharsMsg">Username minimal 4 karakter.</span>
			</span>
          </div>
          <div class="form-group has-feedback">
		  	<span id="sprytf_pwd"> 
			...
			<span class="passwordMinCharsMsg">Password minimal 4 karakter.</span>
			<span class="passwordMaxCharsMsg">Password maksimal 4 karakter.</span>
			</span>
          </div>
          <div class="row">
            <div class="col-xs-8">
