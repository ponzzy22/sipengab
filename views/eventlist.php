...
<div class="col-md-12">
  <div class="box">
    <div class="box-header with-border">
      <h3 class="box-title">Detail Bokingan</h3>
    </div>
    <!-- /.box-header -->
    <div class="box-body">
      <table class="table table-bordered">
        <tr>
          ...
          <th style="width: 140px">Jumlah Komputer</th>
	  ...
	  foreach($records as $rec) {
        ...
        <tr>
		  ...
		  <td><?php if($status == "PENDING") {?>
            <a href="javascript:approve('<?php echo $user_id ?>');">Validasi</a>&nbsp;/
			&nbsp;<a href="javascript:decline('<?php echo $user_id ?>');">Tolak</a>&nbsp;/
			&nbsp;<a href="javascript:deleteUser('<?php echo $user_id ?>');">Hapus</a>
            <?php } else { ?>
